...
// 为需要动画的元素添加观察
document.querySelectorAll('.info-card, .education-card, .experience-card, .project-card, .publication-card, .skill-category, .achievement-card, .task-card, .contact-item').forEach(el => {
    el.style.opacity = '0';
...
// 项目卡片3D效果
document.querySelectorAll('.info-card, .project-card, .education-card, .experience-card, .publication-card, .skill-category, .achievement-card, .task-card').forEach(card => {
